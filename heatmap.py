...
def get_params():
    params = {
        'weight': 'runs/train/base_yolov8n/weights/best.pt', # base_yolov8n ours_yolov8n_tt100k
        'cfg': 'ultralytics/cfg/models/ours/yolov8.yaml',    # yolov8 yolov8-TFF2-p2
        'device': 'cuda:0',
...
if __name__ == '__main__':
    model = yolov8_heatmap(**get_params()) # 9952 7955 6635 4393 3221 662 36
    model(r'ultralytics/assets/9952.jpg', 'result/yolov8n/last/9952')